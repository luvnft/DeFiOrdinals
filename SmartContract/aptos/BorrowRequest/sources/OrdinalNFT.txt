module my_ordinals_loan::ordinal_nft {
    ...
    #[test(aptos = @0x1, account = @my_ordinals_loan, creator = @0x123)]
    ...
    #[test(aptos = @0x1, account = @my_ordinals_loan, creator = @0x123)]
    #[expected_failure(abort_code = E_ORDINAL_DOES_NOT_EXIST, location = my_ordinals_loan::OrdinalNFT)]
